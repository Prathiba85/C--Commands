...
namespace SeleniumLearning
{
    public class waitProgram
    {
        ...
        public void waittest()
        {
            ...
            IWebElement signin = driver.FindElement(By.XPath("//input[@id='signInBtn']"));
            signin.Click();
            //Thread.Sleep(2000);
            WebDriverWait wc = new WebDriverWait(driver, TimeSpan.FromSeconds(5));
            wc.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.TextToBePresentInElementValue(signin, "Sign In"));
